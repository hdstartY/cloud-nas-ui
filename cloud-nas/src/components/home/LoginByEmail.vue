<template>
  <div class="login-form">
    <div class="text-box">
      ...
      <div style="margin-top: 15px"><el-button round type="warning" size="large" style="width: 300px" @click="emailLogin">登录</el-button></div>
      ...
      <div style="margin-top: 5px"><el-button round type="primary" size="large" style="width: 300px" @click="toPhoneLogin">邮箱登录</el-button></div>
